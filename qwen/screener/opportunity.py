...
class OpportunitySummary:
    ...
    opportunities: Optional[list[MispricingOpportunity]] = None
...
class OpportunityScanner:
    ...
    def add_volatility_analysis(self, snapshot: StockSnapshot) -> StockSnapshot:
        ...
        try:
            ...
            logger.warning(f"Vol analysis error for {snapshot.symbol}: {e}")
        ...
        for symbol in symbols:
            ...
            if stock:
                ...
                try:
                    ...
                    logger.debug(f"Failed to create snapshot for {symbol}: {e}")
                    snapshot = None
